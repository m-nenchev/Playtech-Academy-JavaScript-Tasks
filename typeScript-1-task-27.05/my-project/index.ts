    ...
    // Const  for validating instance variables 
        const form = document.querySelector(".form")as HTMLFormElement,
              names = document.querySelector("input[name='name']")as HTMLInputElement
        const selectEmptySpace = document.querySelector(".select-tayp-selector")as HTMLInputElement;
        const colorInput = document.querySelector(".input-selector-color")as HTMLInputElement;
        const phrase = document.querySelector(".textarea")as HTMLInputElement;
        const checkboxCheck = document.querySelector("input[name='robotTalk']")as HTMLInputElement,
              checkboxJump = document.querySelector("input[name='robotJump']")as HTMLInputElement,
              checkboxWinks = document.querySelector("input[name='robotWinks']")as HTMLInputElement,
              errorMsgInputName = document.querySelector(".errorInputName")as HTMLSpanElement,
              errorMsgSelectTayp = document.querySelector(".errorSelectTayp")as HTMLSpanElement,
              errorMsgSelectColor = document.querySelector(".errorSelectColor")as HTMLSpanElement,
              errorTextArea = document.querySelector(".errorTextArea")as HTMLSpanElement

          const liNew = document.createElement("li")as HTMLLIElement,
              inputJump = document.querySelector(".input-checkbox-jump"),
              buttonNext = document.querySelector(".buttonNext")as HTMLButtonElement,
              buttonPrevious= document.querySelector(".buttonPrevious")as HTMLButtonElement,
...
scoreDiv.append(scoreBoardTable)
    ...
    const appendScores = (singleScore:any) => {
        ...
        const typeData = document.querySelector(".nameTableId")as HTMLTableCellElement    
    ...
    function eventListenerNameDataTableRow(currentId:number){
